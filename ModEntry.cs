...
public class Config
    {
        ...
        // Node spawn chance with profession
        ...
        // === Source of truth ===
        public Dictionary<string, ResourceDropRule> Rules { get; set; } = new();

        // === Legacy strongly-typed rules (JsonIgnore) ===
        [JsonIgnore] public ResourceDropRule Stone { get; set; } = new() { Name = "Stone", SkillType = "Mining", Type = "Ore", ObjectID = "(O)390", DropsFromObjectIDs = new() { "32", "34", "36", "38", "40", "48", "50", "52", "54", "56", "58", "343", "450", "668", "670", "760", "762", "845", "846", "847" } };
        [JsonIgnore] public ResourceDropRule CopperOre { get; set; } = new() { Name = "Copper Ore", SkillType = "Mining", Type = "Ore", ObjectID = "(O)378", DropsFromObjectIDs = new() { "751" } };
        [JsonIgnore] public ResourceDropRule IronOre { get; set; } = new() { Name = "Iron Ore", SkillType = "Mining", Type = "Ore", ObjectID = "(O)380", DropsFromObjectIDs = new() { "290" } };
        [JsonIgnore] public ResourceDropRule GoldOre { get; set; } = new() { Name = "Gold Ore", SkillType = "Mining", Type = "Ore", ObjectID = "(O)384", DropsFromObjectIDs = new() { "764" } };
        [JsonIgnore] public ResourceDropRule IridiumOre { get; set; } = new() { Name = "Iridium Ore", SkillType = "Mining", Type = "Ore", ObjectID = "(O)386", DropsFromObjectIDs = new() { "765" } };
        [JsonIgnore] public ResourceDropRule RadioactiveOre { get; set; } = new() { Name = "Radioactive Ore", SkillType = "Mining", Type = "Ore", ObjectID = "(O)909", DropsFromObjectIDs = new() { "95" } };
        [JsonIgnore] public ResourceDropRule CinderShard { get; set; } = new() { Name = "Cinder Shard", SkillType = "Mining", Type = "Ore", ObjectID = "(O)848", DropsFromObjectIDs = new() { "843", "844" } };

        [JsonIgnore] public ResourceDropRule Coal { get; set; } = new() { Name = "Coal", SkillType = "Mining", Type = "Coal&Others", ObjectID = "(O)382", DropsFromObjectIDs = new() { "VolcanoCoalNode0", "VolcanoCoalNode1", "BasicCoalNode0", "BasicCoalNode1" } };
        [JsonIgnore] public ResourceDropRule Clay { get; set; } = new() { Name = "Clay", SkillType = "Mining", Type = "Coal&Others", ObjectID = "(O)330", DropsFromObjectIDs = new() { "818" } };

        [JsonIgnore] public ResourceDropRule Diamond { get; set; } = new() { Name = "Diamond", SkillType = "Mining", Type = "Gem", ObjectID = "(O)72", DropsFromObjectIDs = new() { "2" } };
        [JsonIgnore] public ResourceDropRule Amethyst { get; set; } = new() { Name = "Amethyst", SkillType = "Mining", Type = "Gem", ObjectID = "(O)66", DropsFromObjectIDs = new() { "8" } };
        [JsonIgnore] public ResourceDropRule Aquamarine { get; set; } = new() { Name = "Aquamarine", SkillType = "Mining", Type = "Gem", ObjectID = "(O)62", DropsFromObjectIDs = new() { "14" } };
        [JsonIgnore] public ResourceDropRule Emerald { get; set; } = new() { Name = "Emerald", SkillType = "Mining", Type = "Gem", ObjectID = "(O)60", DropsFromObjectIDs = new() { "12" } };
        [JsonIgnore] public ResourceDropRule Topaz { get; set; } = new() { Name = "Topaz", SkillType = "Mining", Type = "Gem", ObjectID = "(O)68", DropsFromObjectIDs = new() { "10" } };
        [JsonIgnore] public ResourceDropRule Ruby { get; set; } = new() { Name = "Ruby", SkillType = "Mining", Type = "Gem", ObjectID = "(O)64", DropsFromObjectIDs = new() { "4" } };
        [JsonIgnore] public ResourceDropRule Jade { get; set; } = new() { Name = "Jade", SkillType = "Mining", Type = "Gem", ObjectID = "(O)70", DropsFromObjectIDs = new() { "6" } };

        [JsonIgnore] public ResourceDropRule Geode { get; set; } = new() { Name = "Geode", SkillType = "Mining", Type = "Geode", ObjectID = "(O)535", DropsFromObjectIDs = new() { "75" } };
        [JsonIgnore] public ResourceDropRule FrozenGeode { get; set; } = new() { Name = "Frozen Geode", SkillType = "Mining", Type = "Geode", ObjectID = "(O)536", DropsFromObjectIDs = new() { "76" } };
        [JsonIgnore] public ResourceDropRule MagmaGeode { get; set; } = new() { Name = "Magma Geode", SkillType = "Mining", Type = "Geode", ObjectID = "(O)537", DropsFromObjectIDs = new() { "77" } };
        [JsonIgnore] public ResourceDropRule OmniGeode { get; set; } = new() { Name = "Omni Geode", SkillType = "Mining", Type = "Geode", ObjectID = "(O)749", DropsFromObjectIDs = new() { "819" } };

        [JsonIgnore] public ResourceDropRule Oak_Wood { get; set; } = new() { Name = "Oak Wood", SkillType = "Foraging", Type = "Wood", ObjectID = "(O)388", DropsFromObjectIDs = new() { "TreeOak" } };
        [JsonIgnore] public ResourceDropRule Oak_Seed { get; set; } = new() { Name = "Oak Seed", SkillType = "Foraging", Type = "Seed", ObjectID = "(O)309", AddAmount = 2, DropsFromObjectIDs = new() { "TreeOak" } };
        [JsonIgnore] public ResourceDropRule Oak_Resin { get; set; } = new() { Name = "Oak Resin", SkillType = "Foraging", Type = "Tap", ObjectID = "(O)725", DropsFromObjectIDs = new() { "TreeOak" } };

        [JsonIgnore] public ResourceDropRule Maple_Wood { get; set; } = new() { Name = "Maple Wood", SkillType = "Foraging", Type = "Wood", ObjectID = "(O)388", DropsFromObjectIDs = new() { "TreeMaple" } };
        [JsonIgnore] public ResourceDropRule Maple_Seed { get; set; } = new() { Name = "Maple Seed", SkillType = "Foraging", Type = "Seed", ObjectID = "(O)310", AddAmount = 2, DropsFromObjectIDs = new() { "TreeMaple" } };
        [JsonIgnore] public ResourceDropRule Maple_Syrup { get; set; } = new() { Name = "Maple Syrup", SkillType = "Foraging", Type = "Tap", ObjectID = "(O)724", DropsFromObjectIDs = new() { "TreeMaple" } };

        [JsonIgnore] public ResourceDropRule Pine_Wood { get; set; } = new() { Name = "Pine Wood", SkillType = "Foraging", Type = "Wood", ObjectID = "(O)388", DropsFromObjectIDs = new() { "TreePine" } };
        [JsonIgnore] public ResourceDropRule Pine_Seed { get; set; } = new() { Name = "Pine Cone", SkillType = "Foraging", Type = "Seed", ObjectID = "(O)311", AddAmount = 2, DropsFromObjectIDs = new() { "TreePine" } };
        [JsonIgnore] public ResourceDropRule Pine_Tar { get; set; } = new() { Name = "Pine Tar", SkillType = "Foraging", Type = "Tap", ObjectID = "(O)726", DropsFromObjectIDs = new() { "TreePine" } };

        [JsonIgnore] public ResourceDropRule Mahogany_Hardwood { get; set; } = new() { Name = "Mahogany Hardwood", SkillType = "Foraging", Type = "Hardwood", ObjectID = "(O)709", DropsFromObjectIDs = new() { "TreeMahogany" } };
        [JsonIgnore] public ResourceDropRule Mahogany_Seed { get; set; } = new() { Name = "Mahogany Seed", SkillType = "Foraging", Type = "Seed", ObjectID = "(O)292", AddAmount = 2, DropsFromObjectIDs = new() { "TreeMahogany" } };
        [JsonIgnore] public ResourceDropRule Mahogany_Sap { get; set; } = new() { Name = "Sap", SkillType = "Foraging", Type = "Tap", ObjectID = "(O)92", DropsFromObjectIDs = new() { "TreeMahogany" } };

        [JsonIgnore] public ResourceDropRule LargeStump { get; set; } = new() { Name = "Large Stump Hardwood", SkillType = "Foraging", Type = "Hardwood", ObjectID = "(O)709", DropsFromObjectIDs = new() { "LargeStump" }, AddAmount = 2, Multiplier = 1.0 };
        [JsonIgnore] public ResourceDropRule LargeLog { get; set; } = new() { Name = "Large Log Hardwood", SkillType = "Foraging", Type = "Hardwood", ObjectID = "(O)709", DropsFromObjectIDs = new() { "LargeLog" }, AddAmount = 3, Multiplier = 1.0 };

        [JsonIgnore] public ResourceDropRule Sap { get; set; } = new() { Name = "Sap", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)92", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "92" } };
        [JsonIgnore] public ResourceDropRule SeaUrchin { get; set; } = new() { Name = "Sea Urchin", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)397", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "397" } };
        [JsonIgnore] public ResourceDropRule Coral { get; set; } = new() { Name = "Coral", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)393", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "393" } };
        [JsonIgnore] public ResourceDropRule Mussel { get; set; } = new() { Name = "Mussel", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)719", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "719" } };
        [JsonIgnore] public ResourceDropRule Clam { get; set; } = new() { Name = "Clam", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)372", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "372" } };
        [JsonIgnore] public ResourceDropRule Oyster { get; set; } = new() { Name = "Oyster", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)723", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "723" } };
        [JsonIgnore] public ResourceDropRule Seaweed { get; set; } = new() { Name = "Seaweed", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)152", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "152" } };
        [JsonIgnore] public ResourceDropRule CactusFruit { get; set; } = new() { Name = "Cactus Fruit", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)90", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "90" } };

        [JsonIgnore] public ResourceDropRule Daffodil { get; set; } = new() { Name = "Daffodil", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)18", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "18" } };
        [JsonIgnore] public ResourceDropRule Dandelion { get; set; } = new() { Name = "Dandelion", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)22", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "22" } };
        [JsonIgnore] public ResourceDropRule Leek { get; set; } = new() { Name = "Leek", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)20", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "20" } };
        [JsonIgnore] public ResourceDropRule WildHorseradish { get; set; } = new() { Name = "Wild Horseradish", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)16", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "16" } };
        [JsonIgnore] public ResourceDropRule SpringOnion { get; set; } = new() { Name = "Spring Onion", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)399", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "399" } };
        [JsonIgnore] public ResourceDropRule Salmonberry { get; set; } = new() { Name = "Salmonberry", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)296", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "296" } };
        [JsonIgnore] public ResourceDropRule Morel { get; set; } = new() { Name = "Morel", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)257", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "257" } };
        [JsonIgnore] public ResourceDropRule CommonMushroom { get; set; } = new() { Name = "Common Mushroom", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)404", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "404" } };

        [JsonIgnore] public ResourceDropRule SweetPea { get; set; } = new() { Name = "Sweet Pea", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)402", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "402" } };
        [JsonIgnore] public ResourceDropRule SpiceBerry { get; set; } = new() { Name = "Spice Berry", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)396", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "396" } };
        [JsonIgnore] public ResourceDropRule Grape { get; set; } = new() { Name = "Grape", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)398", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "398" } };
        [JsonIgnore] public ResourceDropRule FiddleheadFern { get; set; } = new() { Name = "Fiddlehead Fern", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)490", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "490" } };
        [JsonIgnore] public ResourceDropRule RedMushroom { get; set; } = new() { Name = "Red Mushroom", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)420", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "420" } };

        [JsonIgnore] public ResourceDropRule Blackberry { get; set; } = new() { Name = "Blackberry", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)410", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "410" } };
        [JsonIgnore] public ResourceDropRule Hazelnut { get; set; } = new() { Name = "Hazelnut", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)408", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "408" } };
        [JsonIgnore] public ResourceDropRule WildPlum { get; set; } = new() { Name = "Wild Plum", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)406", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "406" } };
        [JsonIgnore] public ResourceDropRule Chanterelle { get; set; } = new() { Name = "Chanterelle", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)422", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "422" } };
        [JsonIgnore] public ResourceDropRule PurpleMushroom { get; set; } = new() { Name = "Purple Mushroom", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)422", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "422" } };

        [JsonIgnore] public ResourceDropRule WinterRoot { get; set; } = new() { Name = "Winter Root", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)412", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "412" } };
        [JsonIgnore] public ResourceDropRule SnowYam { get; set; } = new() { Name = "Snow Yam", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)416", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "416" } };
        [JsonIgnore] public ResourceDropRule Crocus { get; set; } = new() { Name = "Crocus", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)418", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "418" } };
        [JsonIgnore] public ResourceDropRule CrystalFruit { get; set; } = new() { Name = "Crystal Fruit", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)414", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "414" } };
        [JsonIgnore] public ResourceDropRule Holly { get; set; } = new() { Name = "Holly", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)421", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "421" } };

        [JsonIgnore] public ResourceDropRule Ginger { get; set; } = new() { Name = "Ginger", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)829", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "829" } };
        [JsonIgnore] public ResourceDropRule MagmaCap { get; set; } = new() { Name = "Magma Cap", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)851", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "851" } };

        [JsonIgnore] public ResourceDropRule Coconut { get; set; } = new() { Name = "Coconut", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)88", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "88" } };

        [JsonIgnore] public ResourceDropRule Cherry { get; set; } = new() { Name = "Cherry", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)638", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "638" } };
        [JsonIgnore] public ResourceDropRule Pomegranate { get; set; } = new() { Name = "Pomegranate", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)637", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "637" } };
        [JsonIgnore] public ResourceDropRule Peach { get; set; } = new() { Name = "Peach", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)636", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "636" } };
        [JsonIgnore] public ResourceDropRule Apple { get; set; } = new() { Name = "Apple", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)613", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "613" } };
        [JsonIgnore] public ResourceDropRule Orange { get; set; } = new() { Name = "Orange", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)635", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "635" } };
        [JsonIgnore] public ResourceDropRule Apricot { get; set; } = new() { Name = "Apricot", SkillType = "Foraging", Type = "Forage", ObjectID = "(O)634", AddAmount = 2, Multiplier = 1f, DropsFromObjectIDs = new() { "634" } };


        public Config()
        {

            MergeLegacyIntoRules(overwriteExisting: false);
            UpdateLegacyPropertiesFromRules();
        }
        private void UpdateLegacyPropertiesFromRules()
        {
            foreach (var pi in typeof(Config).GetProperties()
                     .Where(p => p.PropertyType == typeof(ResourceDropRule)))
            {
                var key = pi.Name;
                if (Rules.TryGetValue(key, out var rule) && rule != null)
                    pi.SetValue(this, rule); 
            }
        }
        ...
        private void MergeLegacyIntoRules(bool overwriteExisting)
        {
            foreach (var pi in typeof(Config).GetProperties().Where(p => p.PropertyType == typeof(ResourceDropRule)))
            {
                var rule = (ResourceDropRule)pi.GetValue(this);
                if (rule == null) continue;

                var key = pi.Name; 
                if (overwriteExisting || !Rules.ContainsKey(key))
                    Rules[key] = rule;
            }
        }
    }
    ...
    public class ModEntry : Mod
    {
        ...
        private void OnSaveLoaded(object sender, SaveLoadedEventArgs e)
        {
            ...
            //Rebuilds GMCM so that it uses object item from localized languages
            registerGMCM();
        }
        ...
        public IEnumerable<ResourceDropRule> GetAllRules()
        {
            ...
            return this.Config?.Rules?.Values ?? Enumerable.Empty<ResourceDropRule>();
        }
        ...
        private void ForagingConfigPage(IGenericModConfigMenuApi gmcm)
        {
            ...
            gmcm.AddSectionTitle(ModManifest, text: () => Helper.Translation.Get("gmcm.page.foraging.chop.sectionTitle"), tooltip: () => Helper.Translation.Get("gmcm.page.foraging.chop.tooltip"));
            ...
            gmcm.AddSectionTitle(ModManifest, text: () => Helper.Translation.Get("gmcm.page.foraging.foraged.sectionTitle"), tooltip: () => Helper.Translation.Get("gmcm.page.foraging.foraged.tooltip"));
        ...
        private void MiningConfigPage(IGenericModConfigMenuApi gmcm)
        {
            ...
            gmcm.AddSectionTitle(mod: ModManifest, text: () => Helper.Translation.Get("gmcm.page.mining.drops.title"), tooltip: () => Helper.Translation.Get("gmcm.page.mining.drops.tooltip"));
